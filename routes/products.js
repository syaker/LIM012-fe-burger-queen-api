...
module.exports = (app, nextMain) => {
   ...
   */
  app.get("/products/:productId", requireAuth, getAnProduct);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.post("/products", requireAdmin, createAnProduct);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.put("/products/:productId", requireAdmin, updateAnProduct);
   ...
   * @code {404} si el producto con `productId` indicado no existe
   */
  app.delete("/products/:productId", requireAdmin, deleteAnProduct);
