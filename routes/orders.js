...
module.exports = (app, nextMain) => {
   ...
   */
  app.get("/orders/:orderId", requireAuth, getAnOrder);
   ...
   * @code {401} si no hay cabecera de autenticación
   */
  app.post("/orders", requireAuth, createAnOrder);
   ...
   */
  app.put("/orders/:orderId", requireAuth, updateAnOrder);
   ...
   */
  app.delete("/orders/:orderId", requireAuth, deleteAnOrder);
