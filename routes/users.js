...
module.exports = (app, next) => {
   ...
   */
  app.get("/users/:uid", requireAuth, getAnUser);
   ...
   */
  app.post("/users", requireAdmin, createAnUser);
   ...
   * @code {404} si la usuaria solicitada no existe
   */
  app.put("/users/:uid", requireAuth, updateAnUser);
   ...
   * @code {404} si la usuaria solicitada no existe
   */
  app.delete("/users/:uid", requireAuth, deleteAnUser);
